...
namespace WordLight
{
    public class TextViewWindow : NativeWindow, IDisposable
    {
        ...
        private void DrawSearchMarks(Graphics g, User32.RECT updateRect)
        {
            ...
            DrawRectangles(_freezeMarks1, Color.Aqua, g, clipRect);
            DrawRectangles(_freezeMarks2, Color.Lime, g, clipRect);
            DrawRectangles(_freezeMarks3, Color.Orange, g, clipRect);
        }

        private void DrawRectangles(MarkCollection marks, Color penColor, Graphics g, Rectangle clipRect)
        {
            Rectangle[] rectangles = marks.GetRectanglesForVisibleMarks(_visibleTextStart, _visibleTextEnd, clipRect, _view, _lineHeight, _buffer);
        ...
        private void InvalidateVisibleMarks(MarkCollection marks)
        {
            ...
            Rectangle[] rectList = marks.GetRectanglesForVisibleMarks(_visibleTextStart, _visibleTextEnd, maxClipBounds, _view, _lineHeight, _buffer);
