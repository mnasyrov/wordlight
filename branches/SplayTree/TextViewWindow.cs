...
namespace WordLight
{
    public class TextViewWindow : NativeWindow, IDisposable
    {
        ...
        private void StreamTextChangedHandler(object sender, StreamTextChangedEventArgs e)
        {
            ...
            int start = _textView.VisibleTextStart;
            int end = _textView.VisibleTextStart;

            _freezeMarks1.ReplaceMarks(_freezeSearch1.SearchOccurrences(_freezeText1, start, end));
            _freezeMarks2.ReplaceMarks(_freezeSearch2.SearchOccurrences(_freezeText2, start, end));
            _freezeMarks3.ReplaceMarks(_freezeSearch3.SearchOccurrences(_freezeText3, start, end));
